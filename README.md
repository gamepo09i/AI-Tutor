...
This repository contains curriculum materials for teaching kids how to build with AI using a practical "vibe coding" approach.
...
Use the arrow keys, spacebar, or on-screen buttons to move through the slides.
...
You do not need to upload files one at a time. Work on a useful batch of changes, then commit and push the batch.
...
git status
git add .
git commit -m "Update curriculum slides"
git push
```

People can then download or pull the newest version from GitHub.
